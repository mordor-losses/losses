function getData() {
    return {
        ...
        bbms: [
            ...
            2118, 2162, 2205, 2238, 2258, 2308, 2342, 2389, 2418
        ],
        artillery: [
            ...
            342, 347, 349, 358, 366, 366, 371, 376, 381, 386, 391, 393, 397, 403, 408, 411, 416, 421, 431, 435
        ],
        gradAndBucks: [
            ...
            125, 127, 130, 132, 136, 136, 138, 143, 147, 149, 149, 149, 151, 151
        ],
        ppos: [
        ...
        airplanes: [
            ...
            160, 163, 163, 165, 167, 169, 171, 172, 176, 177, 179, 181, 184, 185, 187, 189
        ],
        helicopters: [
            ...
            140, 143, 144, 144, 145, 146, 147, 150, 150, 151, 153, 154, 154, 154, 154, 155, 155, 155
        ],
        bpla: [
            ...
            165, 166, 172, 182, 191, 201, 205, 207, 215, 229
        ],
        autos: [
            ...
            1543, 1557, 1566, 1643, 1666, 1688, 1695
        ],
        tankers: [
        ...
        boats: [
            ...
            7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8
        ],
        special: [
