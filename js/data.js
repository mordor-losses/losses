function getData() {
    return {
        personal: [
            ...
            16600, 17000, 17200, 17300, 17500, 17700, 17800, 18000, 18300, 18500, 18600, 18900, 19000, 19100
        ],
        tanks: [
        ...
        bbms: [
            ...
            1830, 1844, 1858, 1861, 1891, 1891, 1895
        ],
        artillery: [
        ...
        gradAndBucks: [
            ...
            82, 90, 91, 93, 95, 96, 96, 96, 96, 100, 105, 107, 107, 107, 108, 108, 108
        ],
        ppos: [
            0, 0, 0, 0, 0, 7, 9, 11, 18, 19, 21, 23, 27, 28, 29, 31, 33, 34, 34, 36, 43, 43, 43, 44, 44, 45, 45, 47, 47,
            49, 51, 52, 54, 54, 54, 54, 54, 54, 54, 54, 55, 55, 55, 55, 55
        ],
        airplanes: [
            7, 10, 16, 27, 29, 29, 30, 30, 37, 39, 44, 46, 48, 49, 49, 57, 58, 74, 77, 81, 84, 86, 93, 95, 96, 97, 99,
            101, 108, 115, 117, 121, 123, 127, 131, 135, 143, 143, 143, 147, 150, 150, 150, 150, 151
        ],
        helicopters: [
            6, 7, 18, 26, 29, 29, 31, 31, 37, 40, 48, 68, 80, 81, 81, 83, 83, 86, 90, 95, 108, 108, 112, 115, 118, 121,
            123, 124, 124, 125, 127, 127, 127, 129, 131, 131, 131, 134, 134, 134, 134, 135, 135, 135, 136
        ],
        autos: [
