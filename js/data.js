function getData() {
    return {
        personal: [
            ...
            26350, 26650, 26900, 27200, 27400, 27700, 27900, 28300, 28500, 28700, 28850, 29050
        ],
        tanks: [
        ...
        bbms: [
            ...
            2764, 2808, 2856, 2873, 2900, 2934, 2958, 2974, 3009, 3043, 3063, 3090, 3116, 3141
        ],
        artillery: [
        ...
        gradAndBucks: [
            ...
            172, 179, 185, 185, 185, 191, 193, 195, 195, 195, 198, 199, 199, 200, 201, 201
        ],
        ppos: [
        ...
        airplanes: [
            ...
            196, 199, 199, 199, 199, 199, 199, 199, 200, 200, 200, 200, 201, 202, 203, 204, 204, 204
        ],
        helicopters: [
            ...
            155, 155, 155, 155, 155, 156, 158, 158, 160, 161, 162, 163, 164, 165, 167, 167, 167, 168, 169, 170
        ],
        bpla: [
            ...
            390, 398, 405, 411, 416, 427, 436, 441, 455, 460, 462, 470
        ],
        autos_and_tankers: [
            ...
            1980, 1997, 2019, 2042, 2059, 2087, 2101, 2109, 2137, 2157, 2162, 2178, 2194
        ],
        boats: [
            ...
            11, 11, 12, 12, 12, 12, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13
        ],
        special: [
            ...
            28, 28, 31, 31, 31, 31, 32, 32, 38, 38, 38, 38, 38, 38, 39, 41, 41, 41, 41, 41, 42, 42, 42, 43, 43, 43, 43,
            43, 43
        ],
        missile_rockets: [
            ...
            94, 94, 94, 95, 95, 95, 97, 97, 102, 103, 103, 104, 107
        ]
    }
}