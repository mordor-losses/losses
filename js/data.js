function getData() {
    return {
        personal: [
            ...
            16600, 17000, 17200, 17300, 17500, 17700, 17800, 18000
        ],
        tanks: [
            30, 80, 100, 150, 191, 198, 211, 217, 251, 269, 285, 290, 303, 317, 335, 353, 362, 374, 389, 404, 430, 444,
            450, 466, 476, 498, 509, 517, 530, 561, 575, 582, 586, 597, 605, 614, 625, 631, 644
        ],
        bbms: [
        ...
        artillery: [
            ...
            230, 240, 252, 267, 280, 291, 293, 294, 302, 303, 305, 311, 316, 317, 325
        ],
        gradAndBucks: [
            0, 0, 0, 5, 22, 25, 40, 42, 50, 50, 50, 50, 56, 56, 56, 58, 62, 62, 64, 64, 70, 72, 72, 72, 74, 80, 80, 80,
            82, 90, 91, 93, 95, 96, 96, 96, 96, 100, 105
        ],
        ppos: [
        ...
        airplanes: [
            ...
            101, 108, 115, 117, 121, 123, 127, 131, 135, 143, 143, 143
        ],
        helicopters: [
            6, 7, 18, 26, 29, 29, 31, 31, 37, 40, 48, 68, 80, 81, 81, 83, 83, 86, 90, 95, 108, 108, 112, 115, 118, 121,
            123, 124, 124, 125, 127, 127, 127, 129, 131, 131, 131, 134, 134
        ],
        autos: [
            0, 0, 0, 0, 291, 305, 355, 374, 404, 409, 447, 454, 474, 482, 526, 558, 585, 600, 617, 640, 819, 864, 879,
            914, 947, 969, 1000, 1008, 1033, 1089, 1131, 1144, 1150, 1178, 1184, 1201, 1220, 1236, 1249
        ],
        boats: [
