function getData() {
    return {
        personal: [
            ...
            29600, 29750, 30000, 30150, 30350, 30500, 30700, 30850, 30950
        ],
        tanks: [
        ...
        bbms: [
            ...
            3246, 3258, 3270, 3282, 3302, 3343, 3354, 3366
        ],
        artillery: [
            ...
            599, 604, 606, 606, 617, 623, 628, 631, 643, 649, 659, 661, 675
        ],
        gradAndBucks: [
        ...
        ppos: [
            ...
            91, 93, 93, 93, 93, 93, 93, 93, 93, 93, 93, 93, 93, 93, 94, 95, 95
        ],
        airplanes: [
            ...
            206, 206, 207, 207, 207, 208, 208, 210, 210
        ],
        helicopters: [
            ...
            170, 170, 170, 174, 174, 174, 174, 175, 175, 175
        ],
        bpla: [
        ...
        autosAndTankers: [
            ...
            2226, 2240, 2258, 2275, 2290, 2325, 2329
        ],
        boats: [
        ...
        special: [
            ...
            43, 43, 43, 43, 44, 47, 48, 48, 48, 48, 48, 49, 51, 51
        ]
    }
}