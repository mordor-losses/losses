function getData() {
    return {
        personal: [
            ...
            19500, 19600, 19800, 19900, 20000, 20100, 20300, 20600, 20800, 20900, 21000, 21200
        ],
        tanks: [
            ...
            700, 705, 722, 725, 732, 739, 753, 756, 762, 773, 790, 802, 815, 829, 838
        ],
        bbms: [
        ...
        artillery: [
            ...
            342, 347, 349, 358, 366, 366, 371, 376, 381, 386, 391, 393, 397
        ],
        gradAndBucks: [
        ...
        airplanes: [
            ...
            160, 163, 163, 165, 167, 169, 171, 172, 176
        ],
        helicopters: [
            ...
            140, 143, 144, 144, 145, 146, 147, 150, 150, 151, 153
        ],
        bpla: [
        ...
        special: [
            ...
            21, 21, 21, 22, 24, 24, 24, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 26, 27, 27, 27, 27, 27, 27
        ],
        srbm: [
