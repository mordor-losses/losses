window.languageData = {
    charts: {
        'title': {
            'earth': 'Perdite terrestri',
            'earthOther': 'Altre perdite',
            'sky': 'Perdite dei velivoli',
            'personal': 'Perdite del personale (approssimativo)',
        },
        'tanks': 'Carri armati',
        'bbms': 'Mezzi corazzati',
        'autos': 'Veicoli leggeri',
        'airplanes': 'Aerei',
